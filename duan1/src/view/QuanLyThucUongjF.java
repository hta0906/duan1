 ...
 * @author PC
 */
public class QuanLyThucUongjF extends javax.swing.JFrame {

    /**
     * Creates new form QuanLyThucUongjF
     */
    public QuanLyThucUongjF() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyThucUongjF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuanLyThucUongjF().setVisible(true);
            }
        });
    }
